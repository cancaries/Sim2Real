...
if __name__ == '__main__':
    ...
    Scene_wo_render.initialize_ego_vehicle_w_transform_path(transform_path[10:],behavior_type='aggressive')
    ...
    # Scene_wo_render.generate_background_agents(random_agents=False, close_to_ego=True,spawn_num=10,forward_threshold=10,close_threshold=20,same_lane=True)
    Scene_wo_render.generate_background_agents(random_agents=False, close_to_ego=True,spawn_num=20,forward_threshold=10,close_threshold=30) 
    ...
    for i in range(scene_length):
        # if i == 50:
        #     Scene_wo_render._agent_dict['ego_vehicle']._force_turn_around()
