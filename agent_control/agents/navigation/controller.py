...
class VehiclePIDController():
    ...
    def __init__(self, vehicle_name, args_lateral, args_longitudinal, offset=0, max_throttle=0.75, max_brake=0.3,
                 max_steering=1.0):
        """
        Constructor method.
        ...
        self.past_steering = Scene_wo_render.get_vehicle_control(self._vehicle_name).steer
...
class PIDLongitudinalController():
    ...
    def run_step(self, target_speed, debug=False):
        ...
        """
        current_speed = Scene_wo_render.get_vehicle_speed(self._vehicle_name)
        # print(f'{self._vehicle_name} current_speed: {current_speed} target_speed: {target_speed} actual_speed: {Scene_wo_render._agent_dict[self._vehicle_name].get_speed()}')
        if debug:
...
class PIDLateralController():
    ...
    def run_step(self, waypoint):
        ...
        """
        vehicle_waypoint = Scene_wo_render.get_vehicle_waypoint(self._vehicle_name)
    ...
    def _pid_control(self, waypoint, vehicle_transform):
        ...
        if self._offset != 0:
            ...
            w_loc = w_tran.location + [self._offset*r_vec[0], self._offset*r_vec[1], 0.0]
        else:
