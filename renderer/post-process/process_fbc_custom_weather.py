...
@torch.inference_mode()
def process(input_fg, input_bg, input_bg_only, prompt, image_width, image_height, num_samples, seed, steps, a_prompt, n_prompt, cfg, highres_scale, highres_denoise, lowres_denoise, bg_source,debug=False):
    global BGSource2
    ...
    if debug:
        ...
        img.save(os.path.join(output_dir, f"img_relight.png"))
    pixels = pytorch2numpy(pixels, quant=False)


    return pixels, [fg, None]
