...
def process(input_fg, input_bg, prompt, image_width, image_height, num_samples, seed, steps, a_prompt, n_prompt, cfg, highres_scale, highres_denoise, lowres_denoise, bg_source):
    global t2i_pipe, i2i_pipe,device,vae,unet
    ...
    # cv2.imwrite('/media/magic-4090/47236903-9d2a-4bc7-9828-df4fa4b40bd0/user/blender_workspace/IC-Light/f_w_t.png', pixels[0])
    img.save('/media/magic-4090/47236903-9d2a-4bc7-9828-df4fa4b40bd0/user/blender_workspace/IC-Light/f_w_t.png')
