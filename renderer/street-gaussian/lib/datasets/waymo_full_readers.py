...
def readWaymoFullInfo(path, images='images', split_train=-1, split_test=-1, **kwargs):
    ...
    agents_id = output['agents_id']
    frame_vehicle_data = output['frame_vehicle_data']
    ...
    scene_metadata['agents_id'] = agents_id
    scene_metadata['frame_vehicle_data'] = frame_vehicle_data
