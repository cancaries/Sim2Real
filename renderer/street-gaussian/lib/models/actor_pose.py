...
class ActorPose(nn.Module):      
    ...
    def get_agent_translation(self, track_id, camera: Camera, frame_vehicle_data):
        frame_idx = camera.render_frame_idx
        translation = frame_vehicle_data[frame_idx][track_id]['loc']
        return translation
    ...
    def get_agent_rotation(self, track_id, camera: Camera, frame_vehicle_data):
        frame_idx = camera.render_frame_idx
        # print (frame_idx, track_id)
        theta = frame_vehicle_data[frame_idx][track_id]['rot']
