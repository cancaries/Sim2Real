...
cfg.ply_model_path = "/home/ubuntu/DATA1/junhaoge/sg_assets/agent_ply"
cfg.scene_number = None

parser = argparse.ArgumentParser()
parser.add_argument("--config", default="configs/default.yaml", type=str)
parser.add_argument("--ply_model_path", default="/home/ubuntu/DATA1/junhaoge/sg_assets/agent_ply", type=str)
parser.add_argument("--scene_number", default=None, type=int)
