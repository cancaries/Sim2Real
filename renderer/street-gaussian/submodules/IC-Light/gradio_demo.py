        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        image_width = gr.Slider(label="Image Width", minimum=256, maximum=1920, value=512, step=64)
                        image_height = gr.Slider(label="Image Height", minimum=256, maximum=1080, value=640, step=64)
